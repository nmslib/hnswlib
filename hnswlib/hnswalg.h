...
#ifdef USE_SSE
                _mm_prefetch((char *) (visited_array + *list), _MM_HINT_T0);
                _mm_prefetch((char *) (visited_array + *list + 64), _MM_HINT_T0);
                _mm_prefetch((char *) getDataByInternalId(list[0]), _MM_HINT_T0);
                _mm_prefetch((char *) list[0], _MM_HINT_T0);
#endif
...
#ifdef USE_SSE
                    _mm_prefetch((char *) (visited_array + list[j+1]), _MM_HINT_T0);
                    _mm_prefetch((char *) getDataByInternalId(list[j+1]), _MM_HINT_T0);
#endif
...
#ifdef USE_SSE
                            _mm_prefetch((char *) getDataByInternalId(candidate_set.top().second), _MM_HINT_T0);
#endif
