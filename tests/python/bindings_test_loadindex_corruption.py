...
class LoadIndexCorruptionTestCase(unittest.TestCase):
    def test_malformed_max_elements_throws(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            # Header: offsetLevel0_ (size_t) then max_elements_ (size_t).
            # Leave cur_element_count at 2 but shrink max_elements_ to 1.
    ...
    def test_legitimate_index_loads(self):
        """A normal saved index still loads and searches correctly."""
        dim = 8
        index = hnswlib.Index(space='l2', dim=dim)
